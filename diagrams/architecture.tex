...
\draw[->, replorange, line width=2pt]
    ...
    node[midway, below=16pt, font=\sffamily\footnotesize, align=center]
...
% =====================================================
% Shared Y for the horizontal return segment
\pgfmathsetmacro{\returnY}{-5.2}
\draw[->, finalgreen, line width=2pt, dashed]
    (fin.east) -- ([xshift=-0.3cm]nsframe.east |- fin)
    -- ([xshift=-0.3cm]nsframe.east |- 0,\returnY)
    -- (-4.5, \returnY)
